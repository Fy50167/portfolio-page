        ...
        <>
            <div className = 'wrapper'>
                <div className="animation-wrapper">
                    ...
                    >
                        <div className = 'w-100 h-100 d-flex align-items-center justify-content-evenly z-1 position-relative'>    
                            <button onClick = {() => changeScroll() } className = 'fade-down delay-2 animated position-absolute btn btn-arrow'><img src = {DOWN} className = 'arrow' /></button>
                    ...
                    >
                        <div className = 'w-100 h-100 d-flex align-items-center justify-content-evenly z-1 position-fixed lower-content'>    
                            <button onClick = {() => changeScroll() } className = 'position-absolute btn btn-arrow'><img src = {UP} className = 'arrow' /></button>
                            <div className = 'w-25'>
                                <h2 className = 'stylized'>About Me</h2>
                                <p>Nunc pharetra finibus est at efficitur. Praesent sed congue diam.
                                    Integer gravida dui mauris, ut interdum nunc egestas sed. Aenean sed
